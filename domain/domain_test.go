...
func TestInfo(t *testing.T) {
	...
	err = failpoint.Enable("github.com/daiguadaidai/tidb/domain/MockReplaceDDL", `return(true)`)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = failpoint.Disable("github.com/daiguadaidai/tidb/domain/MockReplaceDDL")
	if err != nil {
		t.Fatal(err)
	}
	...
	err = failpoint.Enable("github.com/daiguadaidai/tidb/ddl/util/ErrorMockSessionDone", `return(true)`)
	if err != nil {
		t.Fatal(err)
	}
	...
	err = failpoint.Disable("github.com/daiguadaidai/tidb/ddl/util/ErrorMockSessionDone")
	if err != nil {
		t.Fatal(err)
	}
