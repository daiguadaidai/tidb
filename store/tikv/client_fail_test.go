...
func (s *testClientSuite) TestPanicInRecvLoop(c *C) {
	c.Assert(failpoint.Enable("github.com/daiguadaidai/tidb/store/tikv/panicInFailPendingRequests", `panic`), IsNil)
	c.Assert(failpoint.Enable("github.com/daiguadaidai/tidb/store/tikv/gotErrorInRecvLoop", `return("0")`), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/daiguadaidai/tidb/store/tikv/panicInFailPendingRequests"), IsNil)
	c.Assert(failpoint.Disable("github.com/daiguadaidai/tidb/store/tikv/gotErrorInRecvLoop"), IsNil)
