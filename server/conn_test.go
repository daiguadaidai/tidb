...
func (ts *ConnTestSuite) TestConnExecutionTimeout(c *C) {
	...
	c.Assert(failpoint.Enable("github.com/daiguadaidai/tidb/server/FakeClientConn", "return(1)"), IsNil)
	...
	c.Assert(failpoint.Disable("github.com/daiguadaidai/tidb/server/FakeClientConn"), IsNil)
}
